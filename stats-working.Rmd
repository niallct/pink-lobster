...
# This season
Season `r conf$year_of_interest`. Latest match in dataset: `r E.dates$all_latest`.
...
For `r conf$club_name`, from `r E.dates$our_earliest` to `r E.dates$our_latest`, n=`r E.dates$count_us`.
For all matches, from `r E.dates$all_earliest` to `r E.dates$all_latest`, n=`r E.dates$count_all`.
